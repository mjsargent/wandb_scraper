...
plt.ylabel("Average Episode Length", fontsize="x-large")
plt.xlim(0,30)
plt.ylim(0,250)
...
plt.grid()
plt.savefig(f"./figures/{env}_average_episode_length.png", dpi=600)
#if a == 2:
